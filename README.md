...
<br />
<div align="center">
  <a href="https://github.com/HustavoJhon/FinProc">
    <img src="./assets/logos/logo.jpg" alt="Logo" width="140" height="140">
  </a>

  <h2 align="center">FINPROC — Sistema de Atención Bancaria</h2>
  ...
  <p align="center">
    ...
    <br /><br />
    <a href="https://github.com/HustavoJhon/FinProc/tree/main/src">Ver Código</a>
    ·
    <a href="https://github.com/HustavoJhon/FinProc/tree/main/build">▶ Ejecutar Programa</a>
    ·
    <a href="https://github.com/HustavoJhon/FinProc/tree/main/tests"> Testing</a>
  </p>

  <div>
    <a href="#"><img src="https://img.shields.io/badge/Proyecto-FINPROC-blue?style=for-the-badge"></a>
...
FINPROC es un sistema educativo que **simula el flujo de atención bancaria** mediante el uso de **estructuras de datos dinámicas en C++**, demostrando cómo se puede optimizar el servicio al cliente a través de algoritmos eficientes.
...
3. Clona este repositorio:
   ```bash
   git clone https://github.com/HustavoJhon/FinProc.git
   cd FinProc
    ```
4. Abre Obsidian → selecciona <b>"Abrir carpeta como bóveda"</b>.
5. Elige la carpeta del proyecto `FinProc`.
...
<p align="center">
  ...
  <sub>© 2025 FINPROC - Proyecto Universitario de Estructura de Datos</sub>
</p>
